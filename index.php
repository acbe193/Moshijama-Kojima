<?php
    ...
    /*
    Theme Name: Mohijama Kojima
    Theme URI: http://stealthsstudios.com/arduino/
    Description: Tema echo para el proyecto 3 de sintesis.
    Version: 1.0
    Author: Kojima
    Author URI: http://stealthsstudios.com/arduino/
    */
    get_header(); 
...
?>
        ...
        <div id="spinner" class="show bg-white position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
            <div class="sp  inner-border text-primary" style="width: 3rem; height: 3rem;" role="status">
                <span class="sr-only">Loading...</span>
            </div>
        </div>
        <!-- Spinner End -->

        <!--INICIO Barra antes del navegador-->
        ...
        <!--FINAL Barra antes del navegador-->

        <!--INICIO Barra de Navegacion y Carrousel-->
        ...
        <!--FINAL Barra de Navegacion y Carrousel-->
            ...
            <div class="container py-5">
                ...
                <div class="testimonial-carousel owl-carousel">
                    ...
                    <div class="testimonial-item text-center rounded pb-4">
                        ...
                        <div c  lass="testimonial-img p-1">
